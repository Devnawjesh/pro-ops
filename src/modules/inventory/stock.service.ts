...
export class StockService {
  ...
  // ✅ 1) DISTRIBUTOR USER FIRST (ignore GLOBAL)
  ...
  // ✅ 3) EMPLOYEE / STAFF: now allow GLOBAL
  ...
  // ✅ 4) EMPLOYEE without GLOBAL: company + distributor scopes
  ...
  if (q.warehouse_id && !merged.includes(String(q.warehouse_id))) {
    throw new ForbiddenException('No access to this warehouse');
  }
